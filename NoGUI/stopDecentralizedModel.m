function stopDecentralizedModel()
    set_param('DecentralizedWindParkModel','SimulationCommand','stop');
    close_system('DecentralizedWindParkModel')
    
    if (exist('decentralizedLog.mat', 'file') == 2)
